...
- Reworked smoke with sphere and cylinder presets, dynamic expansion, visibility control, explosion dispersal, and overlap optimization.
- Optimized fire-cloud terrain spread, overlapping rendering, and server-side processing.
- Improved C4 limits, persistence, automatic cleanup, detonator synchronization, and chain-reaction protection.
- Added safe throwable cleanup, global configuration reload, and administrator cleanup commands.
- Fixed explosion damage, inspect audio, and various edge cases.
- Improved item descriptions, TACZ `HideFlags`, and compatibility with existing content packs.
